...
namespace SignalRServiceExtension.Tests
{
    public class SignalRTriggerUtilsTests
    {
        public static IEnumerable<object[]> QueryStringTestData()
        {
            ...
            yield return new object[] { "?k1=v1&k1=v2", new Dictionary<string, string[]> { ["k1"] = new [] {"v1", "v2"}} };
            yield return new object[] { "?k1=v1&k1=v2&k2=v3", new Dictionary<string, object> { ["k1"] = new[] { "v1", "v2" }, ["k2"] = "v3"} };
        }
        ...
        public static IEnumerable<object[]> HeaderTestData()
        {
            ...
            yield return new object[] {request1.Headers, new Dictionary<string, object>{["k"] = "v"}};

            var request2 = new HttpRequestMessage();
            request2.Headers.Add("k1", "v1");
            request2.Headers.Add("K2", "v2");
            yield return new object[] { request2.Headers, new Dictionary<string, object> { ["k1"] = "v1", ["K2"] = "v2" } };

            var request3 = new HttpRequestMessage();
            request3.Headers.Add("k1", "v1");
            request3.Headers.Add("k1", "v2");
            yield return new object[] { request3.Headers, new Dictionary<string, object> { ["k1"] = new [] {"v1", "v2"}} };

            var request4 = new HttpRequestMessage();
            request4.Headers.Add("k1", "v1");
            request4.Headers.Add("k1", "v2");
            request4.Headers.Add("k2", "v3");
            yield return new object[] { request4.Headers, new Dictionary<string, object> { ["k1"] = new[] { "v1", "v2" }, ["k2"] = "v3" } };
        }
