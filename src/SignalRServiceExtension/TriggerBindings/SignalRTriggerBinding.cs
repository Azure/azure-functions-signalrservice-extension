...
namespace Microsoft.Azure.WebJobs.Extensions.SignalRService
{
    internal class SignalRTriggerBinding : ITriggerBinding
    {
        ...
        public SignalRTriggerBinding(ParameterInfo parameterInfo, SignalRTriggerAttribute attribute, ISignalRTriggerRouter router)
        {
        ...
        public Task<IListener> CreateListenerAsync(ListenerFactoryContext context)
        {
            ...
            _router.MapRouter((_attribute.HubName, _attribute.Target), context.Executor);
