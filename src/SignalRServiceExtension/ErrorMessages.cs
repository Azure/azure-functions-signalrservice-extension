...
namespace Microsoft.Azure.WebJobs.Extensions.SignalRService
{
    ...
    {
        public const string DifferentConnectionStringsErrorMessage = "Different Azure SignalR connection strings set via app setting and attribute are not supported.";
